...
func (x *LoginRequest) GetCommon() *Common {
	if x != nil {
		return x.Common
	}
	return nil
...
var file_login_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x65,
	0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x1a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x70, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x28, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x18,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x45, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72,
	0x12, 0x3a, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x16, 0x2e, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x17, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x2e, 0x4c, 0x6f, 0x67,
...
var file_login_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: entities.LoginRequest
	(*LoginResponse)(nil), // 1: entities.LoginResponse
	(*Common)(nil),        // 2: entities.Common
	(*Error)(nil),         // 3: entities.Error
}
var file_login_proto_depIdxs = []int32{
	2, // 0: entities.LoginRequest.common:type_name -> entities.Common
	3, // 1: entities.LoginResponse.error:type_name -> entities.Error
	0, // 2: entities.Greeter.Login:input_type -> entities.LoginRequest
	1, // 3: entities.Greeter.Login:output_type -> entities.LoginResponse
...
func (c *greeterClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/entities.Greeter/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/entities.Greeter/Login",
	}
